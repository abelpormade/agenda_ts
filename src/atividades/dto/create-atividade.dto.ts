import { IsNotEmpty, IsString,IsDateString, MaxLength, IsBoolean,IsInt, IsEnum, IsOptional, IsDate} from "class-validator";
...
export class CreateAtividadeDto {
 ...
 @IsOptional()
  ...
  @ApiProperty({example:1, description:"A tarefa pode ser atribuida a um contato"})
    @IsInt()
    @IsOptional()
    id_contato:number;
}
